...
require_once( BX_DIRECTORY_PATH_INC . 'gkc_badgeWidgets_s.inc.php' );
	...
	<?php echo badgewidget_topmenu(); ?>
		...
		if(isset($_GET['GID']) && (int)$_GET['GID']>0)
		{
			if(isGroupCreator($member['ID'],(int)$_GET['GID']))
			{
				...
				$GID=(int)$_GET['GID'];
                if(isset($_GET['width']) && $_GET['width'] >= 20) { $width=(int)$_GET['width']; } else { $width=100; }
				$groupUrl = $badgewidgetConf['GroupUrl'].$GID;
				$code = displayGroupiframe($GID, $member['ID']. $width);
				...
				$embedd_code = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&width='.$width.'" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
                $embedd_codeAl = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&order=alfa" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
                $embedd_codeRd = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&order=rand" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
				$embedd_code2 = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget_s.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&width='.$width.'" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
                $embedd_code2Al = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget_s.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&order=alfa" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
                $embedd_code2Rd = '<!--Badge Start --><div id="'.$embedd_div_id.'"><div style="width:350px;text-align:center"><font style="font-size:10px;font-family: verdana;font-weight: none;"><a href="'.$site['url'].'">'.$site['title'].' '._t("_gkc_bw_Groups").'</a></font></div></div><script type="text/javascript" src="'.$site['url'].'load_badge_widget_s.php?GID='.$GID.'&MID='.$member['ID'].'&display=groupiframe&conf='.$embedd_validator_code.'&order=rand" onload="document.getElementById(\''.$embedd_div_id.'\').innerHTML=\'\';"></script><!-- Badge End -->';
				...
				<input type="text" style="width:300px;height:20px;font-size:12px;" onclick="this.select()" value="'.htmlspecialchars($embedd_code2).'" /> 
				</td></tr>
				<tr>
				<td>
