...
<html>
    <head>
        ...
        <!-- Sailaja- Adding new favicon to parentfinder -->
        ...
        <link rel="stylesheet" type="text/css" href="viewourfamilies/css/parentfinder.css?cache=6546543213131"/>
                ...
                <div class="container home" >    
                    <div class="row">   
                        <div id="main"><!-- main left section -->
                            ...
                            <!--<div id="pf_banner">-->
                               <div id= "pf_owl_slider">
                                <div id="owl-example" class="owl-carousel owl-theme">
                                    <div class="item"> <img src="templates/tmpl_par/images/splash/splash_img.png"> </div>
                                    <div class="item"> <img src="templates/tmpl_par/images/pic_index.jpg"> </div>
                                    <div class="item"> <img src="templates/tmpl_par/images/pic_agencies.jpg"> </div>
                                    <!--<div class="item"> <img src="templates/tmpl_par/images/pic_expectant.jpg"> </div>-->
                                    <div class="item"> <img src="templates/tmpl_par/images/pic_couples.jpg"> </div>
                                </div>
                            </div>
                            <!--</div>-->
                            ...
                            <div id="pf_content_id01">
                                ...
                                <div id="pf_content_id02"><!-- left content area with social icons-->
                                    <a target="_blank" href="https://www.facebook.com/parentfinder?ref=ts&fref=ts" class="pf_content_cl02"></a>
                                    <a target="_blank" href="https://twitter.com/ParentFinder10" class="pf_content_cl03"></a>
                                    <a target="_blank" href="https://plus.google.com/104082064684774201396/posts?hl=en" class="pf_content_cl04"></a>
                                    <a target="_blank" href="https://pinterest.com/parentfinder10/" class="pf_content_cl05"></a>
                                    <a target="_blank" href="https://plus.google.com/104082064684774201396/posts?hl=en" class="pf_content_cl06"></a>     
                                </div>                    
                            </div>
                        </div>
