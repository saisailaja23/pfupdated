...
bx_import ('BxDolImageResizee');
bx_import ('BxDolImageResize_scroll');
bx_import ('BxDolImageResize_scroll_new');
...
function imageResizee( $srcFilename, $dstFilename, $sizeX, $sizeY, $forceJPGOutput = false )
{
    $o =& BxDolImageResizee::instance($sizeX, $sizeY);
    $o->removeCropOptions ();
    $o->setJpegOutput ($forceJPGOutput);
    $o->setSize ($sizeX, $sizeY);
    if ((($sizeX == 200) && (200 == $sizeY)) || (($sizeX == 300) && (300 == $sizeY)))
        $o->setSquareResize (true);
    else
        $o->setSquareResize (false);
    return $o->resize($srcFilename, $dstFilename);
...
function imageResize_scroll( $srcFilename, $dstFilename, $sizeX, $sizeY, $forceJPGOutput = false )
{
    $o =& BxDolImageResize_scroll::instance($sizeX, $sizeY);
    $o->removeCropOptions ();
    $o->setJpegOutput ($forceJPGOutput);
    $o->setSize ($sizeX, $sizeY);

    if ((($sizeX == 145) && (200 == $sizeY)) )   
    $o->setSquareResize (true);
    else
        $o->setSquareResize (false);
    return $o->resize($srcFilename, $dstFilename);
}
function imageResize_scroll_new( $srcFilename, $dstFilename, $sizeX, $sizeY, $forceJPGOutput = false )
{
    $o =& BxDolImageResize_scroll_new::instance($sizeX, $sizeY);
    $o->removeCropOptions ();
    $o->setJpegOutput ($forceJPGOutput);
    $o->setSize ($sizeX, $sizeY);

    if ((($sizeX == 300) && (230 == $sizeY)) )   
    $o->setSquareResize (true);
    else
        $o->setSquareResize (false);
    return $o->resize($srcFilename, $dstFilename);
