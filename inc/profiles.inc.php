...
function GetMembershipStatus($memberID, $bOfferUpgrade = true, $bViewActions = true)
{
   ...
   //$viewMembershipActions = "<br />(<a onclick=\"javascript:window.open('explanation.php?explain=membership&amp;type=".$membership_info['ID']."', '', 'width=660, height=500, menubar=no, status=no, resizable=no, scrollbars=yes, toolbar=no, location=no');\" href=\"javascript:void(0);\">"._t("_VIEW_MEMBERSHIP_ACTIONS")."</a>)<br />";
  	...
  	//if($membership_info['ID'] == 2 || $membership_info['ID'] == 23 || $membership_info['ID'] == 24 ) {

        $viewMembershipActions = "<br />(<a onclick=\"javascript:window.open('membershipmatrix.php', '', 'width=660, height=500, menubar=no, status=no, resizable=no, scrollbars=yes, toolbar=no, location=no');\" href=\"javascript:void(0);\">"._t("_VIEW_MEMBERSHIP_ACTIONS")."</a>)<br />";
       //}
      // else {
...
/*
* The function returns Profile ID by given NickName.*/

function getProfileID( $nickName = '' )
{
    if ( $nickName ) {
        $sqlQuery = "SELECT ID FROM `Profiles` WHERE `NickName` = '$nickName'";
        $profileID = (int)db_value($sqlQuery);
    }
    return $profileID;
}
...
// Profile view link change by prashanth 
function getProfileLinks($iID)
{                                                                                            
                                                     
$profileDetails = getProfileInfo($iID);
                            
if($profileDetails['ProfileType'] == 2 || $profileDetails['ProfileType'] == 4){                         
$ProfileLink = $GLOBALS['site']['url'].'extra_profile_view_17.php?id='.$iID; 
}
else {
$ProfileLink = $GLOBALS['site']['url'].'extra_agency_view_29.php?ID='.$iID;  
}                           
return $ProfileLink;
}
// Profile view link change ends here 
...
function bx_logout($bNotify = true)
{
    ...
    setcookie('Deano', '', time() - 96 * 3600, $sPath);
...
$stateAbb['Alaska'] = 'AK';
$stateAbb['Arizona'] = 'AZ';
$stateAbb['Arkansas'] = 'AR';
$stateAbb['California'] = 'CA';
$stateAbb['Colorado'] = 'CO';
$stateAbb['Connecticut'] = 'CT';
$stateAbb['Delaware'] = 'DE';
$stateAbb['District of Columbia'] = 'DC';
$stateAbb['Florida'] = 'FL';
$stateAbb['Georgia'] = 'GA';
$stateAbb['Hawaii'] = 'HI';
$stateAbb['Idaho'] = 'ID';
$stateAbb['Illinois'] = 'IL';
$stateAbb['Indiana'] = 'IN';
$stateAbb['Iowa'] = 'IA';
$stateAbb['Kansas'] = 'KS';
$stateAbb['Kentucky'] = 'KY';
$stateAbb['Louisiana'] = 'LA';
$stateAbb['Maine'] = 'ME';
$stateAbb['Maryland'] = 'MD';
$stateAbb['Massachusetts'] = 'MA';
$stateAbb['Michigan'] = 'MI';
$stateAbb['Minnesota'] = 'MN';
$stateAbb['Mississippi'] = 'MS';
$stateAbb['Missouri'] = 'MO';
$stateAbb['Montana'] = 'MT';
$stateAbb['Nebraska'] = 'NE';
$stateAbb['Nevada'] = 'NV';
$stateAbb['New Hampshire'] = 'NH';
$stateAbb['New Jersey'] = 'NJ';
$stateAbb['New Mexico'] = 'NM';
$stateAbb['New York'] = 'NY';
$stateAbb['North Carolina'] = 'NC';
$stateAbb['North Dakota'] = 'ND';
$stateAbb['Ohio'] = 'OH';
$stateAbb['Oklahoma'] = 'OK';
$stateAbb['Oregon'] = 'OR';
$stateAbb['Pennsylvania'] = 'PA';
$stateAbb['Rhode Island'] = 'RI';
$stateAbb['South Carolina'] = 'SC';
$stateAbb['South Dakota'] = 'SD';
$stateAbb['Tennessee'] = 'TN';
$stateAbb['Texas'] = 'TX';
$stateAbb['Utah'] = 'UT';
$stateAbb['Vermont'] = 'VT';
$stateAbb['Virginia'] = 'VA';
$stateAbb['Washington'] = 'WA';
$stateAbb['West Virginia'] = 'WV';
$stateAbb['Wisconsin'] = 'WI';
$stateAbb['Wyoming'] = 'WY';
