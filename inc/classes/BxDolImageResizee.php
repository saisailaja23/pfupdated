...
class BxDolImageResizee {

    var $w = 200, $h = 200; // size of destination image
    var $_isCrop = false;
    ...
    function BxDolImageResizee() {
        $this->_isUseGD = getParam('enable_gd') == 'on' && extension_loaded('gd') ? true : false;
	}

    function & instance() {
        if (!isset($GLOBALS['oBxDolImageResizee']))
        $GLOBALS['oBxDolImageResizee'] = new BxDolImageResizee ();
        return $GLOBALS['oBxDolImageResizee'];
    }
