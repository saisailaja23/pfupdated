...
class BxDolImageResize_scroll_new {

    var $w = 300, $h = 230; // size of destination image
    var $_isCrop = false;
    ...
    function BxDolImageResize_scroll_new() {
        $this->_isUseGD = getParam('enable_gd') == 'on' && extension_loaded('gd') ? true : false;
	}

    function & instance() {
        if (!isset($GLOBALS['oBxDolImageResize_scroll_new']))
        $GLOBALS['oBxDolImageResize_scroll_new'] = new BxDolImageResize_scroll_new ();
        return $GLOBALS['oBxDolImageResize_scroll_new'];
    }
