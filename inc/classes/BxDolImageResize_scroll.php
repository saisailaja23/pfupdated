...
class BxDolImageResize_scroll {

    var $w = 145, $h = 200; // size of destination image
    var $_isCrop = false;
    ...
    function BxDolImageResize_scroll() {
        $this->_isUseGD = getParam('enable_gd') == 'on' && extension_loaded('gd') ? true : false;
	}

    function & instance() {
        if (!isset($GLOBALS['oBxDolImageResize_scroll']))
        $GLOBALS['oBxDolImageResize_scroll'] = new BxDolImageResize_scroll ();
        return $GLOBALS['oBxDolImageResize_scroll'];
    }
