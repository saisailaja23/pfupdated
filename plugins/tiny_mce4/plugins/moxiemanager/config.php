<?php
	// General
	$moxieManagerConfig['general.license'] = '5AX4-UPQQ-X2T7-RJ4S-TNDH-RGFL-LM2G-JJMA';
	...
	//$moxieManagerConfig['filesystem.rootpath'] = './data/files';
     //  $moxieManagerConfig['filesystem.rootpath'] = '/var/www/html/pf/plugins/tiny_mce4/plugins/moxiemanager/data/files';
      ...
      //Get Nick from DB using member ID
                                    ...
                                    $result = mysql_query( "SELECT * FROM `Profiles` WHERE `ID` = ".$_COOKIE['memberID']);
                                    $aArr = mysql_fetch_array($result);
        define("USER_FILE_PATH",$aArr['NickName']."/")  ;

    // $_SESSION['moxiemanager.filesystem.rootpath'] = "../../../../media/users/".USER_FILE_PATH; // absolute or relative from this script path, optional.
 
       $moxieManagerConfig['filesystem.rootpath'] = "../../../../media/users/".USER_FILE_PATH; // absolute or relative from this script path, optional.

       if(!file_exists($moxieManagerConfig['filesystem.rootpath']) && !is_dir($moxieManagerConfig['filesystem.rootpath']))
       {

       	mkdir($moxieManagerConfig['filesystem.rootpath']);
       }
   ...
   //  $_SESSION['moxiemanager.filesystem.rootpath'] = "/var/www/html/pf/plugins/tiny_mce4/plugins/moxiemanager/data/files/"; // Set a root path for this use
     ...
     $_SESSION['moxiemanager.filesystem.rootpath'] = "../../../../media/users/".USER_FILE_PATH; // absolute or relative from this script path, optional.
      ...
      //  $mcImageManagerConfig['filesystem.path'] = "../../../../media/users/".USER_FILE_PATH; // absolute or relative from this script path, optional.
