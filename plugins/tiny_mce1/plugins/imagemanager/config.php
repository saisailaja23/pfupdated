<?php
	...
	$mcImageManagerConfig['filesystem'] = "Moxiecode_LocalFileImpl";
        ...
        $mcImageManagerConfig['filesystem.rootpath'] = "../../../../media/users/".USER_FILE_PATH;// absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^'.$_COOKIE['memberID'].'$/i';
	...
	$mcImageManagerConfig['thumbnail.enabled'] = true; // false default, verify that you have GD on your server
        $mcImageManagerConfig['thumbnail.folder'] = $_COOKIE['memberID']; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
	...
	$mcImageManagerConfig['thumbnail.prefix'] = $_COOKIE['memberID']."_"; //
