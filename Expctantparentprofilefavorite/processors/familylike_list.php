...
list($width, $height) = getimagesize("$sImage");
 ...
 $photo = '<img style="background-color: #EDEDED;border: 1px solid #CCCCCC"; width:'.$width.'px; height:'.$height.'px;margin-left:'.$margin_left.'px;margin-top:'.$margin_top.'px;" src="' . $sImage . '">';
...
$faiths_ary = explode(",",$row_agency[6]);
