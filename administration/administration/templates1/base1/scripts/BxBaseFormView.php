...
BLAH;
    ...
    function addCssJs($isDateControl = false, $isDateTimeControl = false)
    {
        ...
        if ($isDateTimeControl) {
            ...
            $aCalendarLangs = array ('af' => 1, 'bg' => 1, 'ca' => 1, 'cs' => 1, 'de' => 1, 'el' => 1, 'es' => 1, 'et' => 1, 'eu' => 1, 'fi' => 1, 'fr' => 1, 'gl' => 1, 'he' => 1, 'hu' => 1, 'id' => 1, 'it' => 1, 'ja' => 1, 'ko' => 1, 'lt' => 1, 'nl' => 1, 'no' => 1, 'pl' => 1, 'pt-BR' => 1, 'pt' => 1, 'ro' => 1, 'ru' => 1, 'sk' => 1, 'sv' => 1, 'th' => 1, 'tr' => 1, 'uk' => 1, 'vi' => 1, 'zh-CN' => 1, 'zh-TW' => 1);

            $aJs[] = 'jquery-ui-timepicker-addon.js';
            $aJs[] = 'jquery-ui-sliderAccess.js';
            if (isset($aCalendarLangs[$GLOBALS['sCurrentLanguage']]))
                $aJs[] = 'plugins/jquery/i18n/|jquery-ui-timepicker-' . $aCalendarLangs[$GLOBALS['sCurrentLanguage']] . '.js';
