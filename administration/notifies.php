...
<?php
    ...
    return DesignBoxAdmin(_t('_adm_mmail_title'), $sResult, $GLOBALS['aTopItems'], '', 1);
}
...
<?php
    ...
    return DesignBoxContent(_t('_adm_mmail_All_Messages'), $sResult, 1);
}
...
function getEmailMessage($sAction)
{
    ...
    return DesignBoxContent(_t('_adm_mmail_Email_message'), $sResult . $oForm->getCode(), 1);
}
...
function getQueueMessage()
{
    ...
    if ( $_POST['msgs_id'] ) {
        ...
        return DesignBoxContent(_t('_adm_mmail_Queue_message'), $oForm->getCode() . $sTmplResult, 1);
    }
}
...
function PreviewMessage()
{
    ...
    return DesignBoxContent(_t('_Preview'), $aMessage['body'], 1);
}
