...
//            $trimText = preg_replace('/[^a-zA-Z0-9]/', "_", $trimText);
//            $trimText = $row[$column_name];
    ...
    array_push($arrValues, $row['PostCaption']);
...
$epub_name_arr = explode('.', $E_pup_link);
...
$getDefaulTempID = isset($getDefaultDetails['template_user_id']) ? $getDefaultDetails['template_user_id'] : "";
$getorgTempID = isset($getDefaultDetails['template_id']) ? $getDefaultDetails['template_id'] : "";
...
$ProfileQ = db_arr("SELECT template_file_path  FROM pdf_template_user WHERE user_id ={$logid} AND isDeleted = 'N' AND isDefault ='Y' LIMIT 1");
