...
echo $aData;
    ...
    $sql = "SELECT distinct * FROM `Profiles` WHERE (`DescriptionMe` LIKE '%$search%' or `FirstName` LIKE '%$search%' or`LastName` LIKE '%$search%' or`DearBirthParent` LIKE '%$search%' or `About_our_home` LIKE '%$search%') AND `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active' Limit 12";
    }
...
elseif(isset($_GET['max_race_id'])) {
   ...
   $where .= "`DescriptionMe` LIKE '1'";
    ...
    $sql = "SELECT distinct * , CHAR_LENGTH( DearBirthParent ) , COUNT( * ) FROM `Profiles`  WHERE ( ".$where." ) AND `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active'  GROUP BY ID";
	...
	$sql = "SELECT distinct * , CHAR_LENGTH( DearBirthParent ) , COUNT( * ) FROM `Profiles`  WHERE `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active'  GROUP BY ID";
    }
...
while($row = mysql_fetch_array($result))
{
  ...
  if(isset($_GET['pstart']) && isset($_GET['pend'])){
   ...
   $search = $_GET['search'];
    $sql = "SELECT distinct * FROM `Profiles` WHERE (`DescriptionMe` LIKE '%$search%' or `FirstName` LIKE '%$search%' or`LastName` LIKE '%$search%' or`DearBirthParent` LIKE '%$search%' or `About_our_home` LIKE '%$search%') AND `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active' $limit";
    //echo $sql;
    //exit();
    $result = mysql_query($sql);
    $id = '';
  ...
  //echo $id;
   ...
   //$limit = "LIMIT 0, 12";
    ...
    //$limit = "LIMIT 0, 70";
    $search = $_GET['search'];
    $sql = "SELECT distinct * FROM `Profiles` LEFT JOIN `bx_avatar_images` ON `Profiles`.`ID` = `bx_avatar_images`.author_id WHERE ( ".$where." ) AND `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active'  GROUP BY `Profiles`.`ID` ORDER BY  `bx_avatar_images`.id DESC $limit";
    //echo $sql;
...
//die;
  ...
  //echo $id;
   ...
   $sql = "SELECT distinct * FROM `Profiles` WHERE `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active' ";
    $result = mysql_query($sql);
    $id = '';
    while($row = mysql_fetch_array($result))
  {
...
elseif(isset($_GET['featuredFamily'])){
	...
	$sql = "SELECT distinct * , CHAR_LENGTH( DearBirthParent ) , COUNT( * ) FROM `Profiles` WHERE `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Status` = 'Active'  GROUP BY ID ORDER BY `Profiles`.`Avatar`";
	...
	`sys_acl_levels_members`.IDLevel =5 GROUP BY `Profiles`.ID ORDER BY `Profiles`.`Avatar` DESC $limit"; */
       ...
       `bx_avatar_images` ON `Profiles`.`ID` = `bx_avatar_images`.author_id WHERE `AdoptionAgency` = '29' AND `ProfileType` != '8' AND `Profiles`.`Status` = 'Active' GROUP BY `Profiles`.ID ORDER BY `bx_avatar_images`.id DESC  $limit";
          //echo $sql;
    $result = mysql_query($sql);
    $id = '';
    while($row = mysql_fetch_array($result))
