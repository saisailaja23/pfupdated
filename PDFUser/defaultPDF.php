...
require_once('/var/www/html/pf/inc/header.inc.php');
...
//require_once ($dir['root'] . 'PDFUser/generatePDF.php');
//require_once('PDFreactor/wrappers/php/lib/PDFreactor.class.php');
require_once($dir['root'] . 'PDFUser/resizeImage.php');
require_once($dir['root'] . 'PDFUser/rotate_img.php');
ini_set('memory_limit','1024M');
...
while($row_parebts = mysql_fetch_assoc($result_parents))
{
    ...
    if(!$userPDFCount)
    {
       ...
       try
       {
           $log_file   = $GLOBALS['dir']['root']."PDFTemplates/parent_log_".date("m-Y").".txt";
           ob_start();
           if($createCounter < 5)
           {
                ...
                if($membership_info['ID'] == '2' || $membership_info['ID'] == '25') {
               ...
               //  $fileName       = $genObject->genWKHTML();
                ...
                if($fileName == 'no data')
                {
                        ...
                        echo "No Data for creating PDF for parent nick name ".$row_parebts['NickName']."\n";
                ...
                else
                {
                   ...
                   //$email_subject   = "Default PDF profile creation - ".$parent_Name;
                   ...
                   echo "parent name ".$parent_Name."\n";
                   echo "counter ".$createCounter."\n";
                   echo "PDF Ceated for parent nick name ".$row_parebts['NickName']."\n";
                   echo "parent id ".$parentID."\n";
...
$email_body    = "";
$pcounter      = 1;
$email_body    .= "Default PDf has been created for below listed users.";
echo " parent array <br/>";
print_r($parent_array);
echo "<br/>";
foreach($parent_array as $pName)
{
    $email_body   .= "<div style='position:relative;width:200px;'>".$pcounter.". ".$pName."</div>";
    $pcounter      += 1;
}
//$email_id        = "arun@mediaus.com";
$email_subject   = "Default PDF profile creation - ";
//$email_body      = "Default Profile PDf has been created for the user '".$parent_Name."'";
