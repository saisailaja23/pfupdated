...
EOF;
	...
	*/
    function setCustomSubActions(&$aKeys, $sActionsType, $bSubMenuMode = true) {
		...
		$this->sCustomActions = '<div class="menu_user_actionss">' . $sActions . '</div>';
	}
    ...
    Customize Profile
		...
		<tr>
                 ...
                 <div  style="width: 100%; margin: 0pt;" class="button_wrapper" >
					<div class="button_wrapper_close" ></div>
    					<div class="button_input_wrapper" style="line-height:10px">
                                  <img src="{$site['url']}modules/aqb/pcomposer/templates/base/images/icons/new_block.png" alt="Upload Profile" style="vertical-align:top;margin-top:5px;margin-left:4px;"  >
    					<a href="file_upload.php?TB_iframe=true&height=140&width=400&modal=true" class="thickbox" style="text-decoration:none;"><input type='button' name='contact' value='Upload Profile' class='form_input_submit' style="padding-left:0px;"/></a>
    					</div>
				</div>
              </td> 
			...
			<!-- <td width="50%"></td> -->
					...
					<div class="button_wrapper_close"></div>
    					<div class="button_input_wrapper">
    						<a href="http://pdfcrowd.com/url_to_pdf/" style="height:25px;text-decoration:none;">	
							<button class="form_input_submit" type="button" >
