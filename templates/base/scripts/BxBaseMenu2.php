...
<?
		...
		return array (
                    'id'=> 'searchicon',
                    'url' => "window.location='http://help.cairsolutions.com/index.php?a=add&catid=4'",
...
EOF;
		...
		if(!isMember()){
			$sLoginSection = $GLOBALS['oSysTemplate']->ParseHtmlByName('login_join.html', array(                            
                            'p' => '
    <a href="http://pdfcrowd.com/url_to_pdf/" style="height:20px; float:right;">	<button class="form_input_submit" type="button" >
