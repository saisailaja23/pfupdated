        ...
        //--- Privacy for Profile page ---//
			...
			if($aBlock['Content']=='118'){
                     ...
                     if($aBlock['Content']=='126'){
                      ...
                      if($aBlock['Content']=='121'){

                        if ($_profile['Couple'] == 0 || $_profile['Couple'] == '') {
                        $aBlock['Caption'] = 'ABOUT ME';
                        }
                        else {
                        $aBlock['Caption'] = 'ABOUT US';
                 		}
                        ...
                        if($aBlock['Func']=='DescriptionPerson1'){
                		$aBlock['Caption']= 'About '.$_profile['NickName'];
                 		}
                 	 if($aBlock['Func']=='DescriptionPerson2'){
                		$aBlock['Caption']= 'About '.$_couplePro['NickName'];
                		}
			if($aBlock['Content']=='118'){
                		 $aBlock['Caption'] = 'Interests of '.$_profile['NickName'];
                 		}
                     if($aBlock['Content']=='125'){
                		 $aBlock['Caption'] = 'Interests of '.$_couplePro['NickName'];
                 		}
                     if($aBlock['Content']=='119'){
                		 $aBlock['Caption'] = 'Hobbies of '.$_profile['NickName'];
                 		}
                     if($aBlock['Content']=='126'){
                		 $aBlock['Caption'] = 'Hobbies of '.$_couplePro['NickName'];
                 		}  
...
//--- AQB Profile Types Splitter ---//
    ...
    function showBlockEcho( $sCaption, $sContent )
    {
	 ...
	 function popup($title,$name,$titleDescription='')
{
...
<style>
 ...
 <!--a href = "javascript:void(0)" onclick = "tinyMCE.execCommand('mceAddControl', false, '{$title}');document.getElementById('{$title}light').style.display='block';document.getElementById('{$title}fade').style.display='block';document.getElementById('{$title}_ifr').style.width='100%';document.getElementById('{$title}_tbl').style.width='100%'"><span style="width:100%; height:40px; background-color:#9FD6FD; border: solid; color:#02618E; font-family:Georgia; font-size:15px; padding:10px;">Please click Edit to enter data to the block.</span></a-->
    <div id="{$title}light" class="{$title}white_content">
        <div id="{$title}fade" class="{$title}black_overlay">
              <div style=" height: 25px; margin-bottom: 2px; font-size: 13px; width: 748px; background-image: url('{$site['url']}templates/base/images/buttonBackground.jpg'); border: 1px solid #BDBEC0; margin-bottom: 4px;"><div style="float:left;font-size: 15px; padding: 5px;" ><b> Edit My Block : </b></div><div style="float:right;"><a href = "javascript:void(0)" onclick = "document.getElementById('{$title}light').style.display='none';document.getElementById('{$title}fade').style.display='none';tinyMCE.execCommand('mceRemoveControl', false, '{$title}');"><img src='{$site['url']}templates/base/images/close_popup.gif'/></a></div></div>
                     <form method="POST" action="blockupdate.php">
                                <table class="form_advanced_table" style=" height: 340px; width: 750px; padding=0px;">
                                        <tr>
                                            <td >
                        ...
                        Title:
                                            ...
                                            <td >
              <input type="hidden" name="title"   value="{$name}">{$titleDescription}</td>
                                        </tr>
                                        <tr>
                                            <td >
                        <span class="required">*</span>
                        Content:
                                            ...
                                            <td  style=" height: 240px;width:630px;">
                                               <div class="input_wrapper input_wrapper_textarea"  style=" height: 240px;width:630px;">
                                                    
                                                    <div class="value">
                                                    <div class="clear_both"></div>
                                                                    <textarea  counter="true"  style="width: 630px;  height: 240px; " id ="{$title}"  name="{$title}"></textarea>
                                                    <div class="clear_both"></div>
                                                    </div>
                                                </div>                                            
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:2px;">
                                            <input type="submit" id="Submit"  name="Submit" style="color: grey;cursor: pointer;font-weight:bold;padding:4px 15px;" value="Save">
                                            &nbsp;&nbsp;&nbsp;&nbsp;
...
function editpopup($title,$name,$content,$titleDescription)
{
...
<style>
 ...
 <a href = "javascript:void(0)" onclick = "tinyMCE.execCommand('mceAddControl', false, '{$title}');document.getElementById('{$title}light').style.display='block';document.getElementById('{$title}fade').style.display='block';document.getElementById('{$title}_ifr').style.width='100%';document.getElementById('{$title}_tbl').style.width='100%'"><span><!--Edit--></span></a>
    <div id="{$title}light" class="{$title}white_content">
        <div id="{$title}fade" class="{$title}black_overlay">
              <div style=" height: 25px; margin-bottom: 2px; font-size: 13px; width: 748px; background-image: url('{$site['url']}templates/base/images/buttonBackground.jpg'); border: 1px solid #BDBEC0; margin-bottom: 4px;"><div style="float:left;font-size: 15px; padding: 5px;" ><b> Edit My Block : </b></div><div style="float:right;"><a href = "javascript:void(0)" onclick = "document.getElementById('{$title}light').style.display='none';document.getElementById('{$title}fade').style.display='none';tinyMCE.execCommand('mceRemoveControl', false, '{$title}');"><img src='{$site['url']}templates/base/images/close_popup.gif'/></a></div></div>
                     <form method="POST" action="blockupdate.php">
                        ...
                        Content:
                                            ...
                                            <td  style=" height: 240px;width:630px;">
                                               <div class="input_wrapper input_wrapper_textarea"  style=" height: 240px;width:630px;">
                                                    <div class="value">
                                                    <div class="clear_both"></div>
                                                                    <textarea  counter="true"  style="width: 630px;  height: 240px; " id ="{$title}"  name="{$title}">{$content}</textarea>
                                                    <div class="clear_both"></div>
                                                    </div>
                                                </div>                                            
                                            </td>
...
return $block;   
	...
	function showDescriptionPerson1()
	{
       ...
       $mem_id  = getMemberMembershipInfo($guestid);
...
$titleDescription = 'About '.$this->_aProfile['FirstName'];
$content = $sRet;
$link = $this->editpopup($title, $name , $content,$titleDescription);

if(!$this->_aProfile['DescriptionMe'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
{
	//return '';
...
return $this->popup($title,$name ,$titleDescription);
}              
if(!($this->_aProfile['DescriptionMe']))
	...
	{	    
		...
		$content = $sRet;
		$title = 'PFblockstd_description22';
		$name = 'Parent2_description';
		$titleDescription = 'About '.$_cPro['FirstName'];
		$link = $this->editpopup($title, $name , $content,$titleDescription);

               
if(!$_cPro['DescriptionMe'] && ($this->_iProfileID == getLoggedId()) && $mem_id['ID'] != 25)
{
	//return '';
...
return $this->popup($title,$name,$titleDescription);
 ...
 if(!$_cPro['DescriptionMe'])
    ...
    function showBlockPFBlock( $iPageBlockID, $sCaption, $sContent, $bNoDB = false )
    {
	 ...
	 $_cPro=getProfileInfo($this->_aProfile['Couple']);
      // $membership_info = getMemberships(); 
      ...
      $sRet.= $this->_aProfile['DescriptionMe'];
		...
		//if(!$this->_aProfile['DearBirthParent']&& ($this->_iProfileID == getLoggedId()||isAdmin()))
              if(!$this->_aProfile['DearBirthParent'] && ($this->_iProfileID == getLoggedId()|| isAdmin()) && $this->_aProfile['ProfileType'] != 4 && $this->_aProfile['ProfileType'] != 8 && $mem_id['ID'] != 25)
		{
			//return '';
			//return '<div style="width:auto; height:40px; background-color:#9FD6FD; color:#02618E; font-family:Georgia; font-size:18px; padding:10px;">Please click <a href="BlockEdit.php?name=DearBirthParent">Edit</a> to enter data to this block.</div>';
                         ...
                         return $this->popup($title,$name,'Birth Parent Letter');
		}
        ...
        }else if($sContent == 118 && $this->_aProfile['ProfileType'] != 4 )
        {
	    $field_catcher= 'Interests';

		if(!$this->_aProfile['Interests'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
		{
			//return '';
			//return '<div style="width:auto; height:40px; background-color:#9FD6FD; color:#02618E; font-family:Georgia; font-size:18px; padding:10px;">Please click <a href="BlockEdit.php?name=Interests">Edit</a> to enter data to this block.</div>';
                    ...
                    $titleDescription = 'Interests of '.$this->_aProfile['FirstName'];
                    return $this->popup($title,$name,$titleDescription);
		} 
	...
	if($this->_aProfile['Couple'] !=0  ){
		$field_catcher= 'Interests';
		if(!$_cPro['Interests'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
		{
			//return '';
			//return '<div style="width:auto; height:40px; background-color:#9FD6FD; color:#02618E; font-family:Georgia; font-size:18px; padding:10px;">Please click <a href="BlockEdit.php?namedes=Interests&id='.$_cPro['ID'].'">Edit</a> to enter data to this block.</div>';
                    ...
                    $titleDescription = 'Interests of '.$_cPro['FirstName'];
                    return $this->popup($title,$name, $titleDescription);
		} 
		...
		if(!$_cPro['Hobbies'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
		{
			//return '';
			//return '<div style="width:auto; height:40px; background-color:#9FD6FD; color:#02618E; font-family:Georgia; font-size:18px; padding:10px;">Please click <a href="BlockEdit.php?namedes=Hobbies&id='.$_cPro['ID'].'">Edit</a> to enter data to this block.</div>';
                    ...
                    $titleDescription = 'Hobbies of '.$_cPro['FirstName'];
                    return $this->popup($title,$name,$titleDescription);
		} 
	...
	else if($sContent == 119 && $this->_aProfile['ProfileType'] != 4)
        {
		 
					           $field_catcher= 'Hobbies';
		if(!$this->_aProfile['Hobbies'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
		{
			//return '';
		    ...
		    $title = 'PFblockstd_Hobbies1';
                    ...
                    $titleDescription = 'Hobbies of '.$this->_aProfile['FirstName'];
                    return $this->popup($title,$name,$titleDescription);
		} 
		...
		if(!$this->_aProfile['About_our_home'] && ($this->_iProfileID == getLoggedId()||isAdmin()) && $mem_id['ID'] != 25)
		{
			//return '';
		    ...
		    $title = 'PFblockstd_About_our_home';
                    $name = 'About_our_home';
                    $titleDescription = 'Our Home';
                    return $this->popup($title,$name,$titleDescription);

		} 
             $sRet=$this->_aProfile['About_our_home'];        
	  }else if($sContent == 121 && $this->_aProfile['ProfileType'] != 4 && $mem_id['ID'] != 25){
...
EOH;
            ...
            if($bMayEdit && $sRet)
                 if($sContent == 109){
						$title = 'PFblockstd_DearBirthParent';
                         			$name = 'DearBirthParent';
						$content = $sRet;
						$link = $this->editpopup($title, $name , $content,'Birth Parent Letter');
    			...
    			return array(
                    ...
                    '',
						...
						$title = 'PFblockstd_About_our_home';
                    			$name = 'About_our_home';
						$content = $sRet;
						$link = $this->editpopup($title, $name , $content ,'Our Home');
    ...
    if($sDesc)
    {
        ...
        <div class="form_advanced_wrapper view_profile_form_wrapper">
            <table cellspacing="0" cellpadding="0" style="border-left: 1px solid #DADADA;border-right: 1px solid #DADADA;border-top: 1px solid #DADADA;font-size: 11px;position: relative;width: 100%;font-size:12px;height:30px;">
...
function getABoutUsView($iPageBlockID, $iPFBlockID) {
	...
	$agencyid = $this->_aProfile['AdoptionAgency'];
   	...
   	$notagency = (getLoggedId() != $agency['author_id'] );
        ...
        // Not to show couple BPdrinking preference

       $this->_aCouple['BPDrinking'] = '';
...
//--- AQB Profile Types Splitter ---//
        ...
        foreach( $aSearchBlocks as $iBlockID => $aBlock ) {
            foreach( $aBlock['Items'] as $aItem ) {
                ...
                switch( $aItem['Type'] ) {
                    ...
                    case 'area':
                        if( $sItemName == 'Tags' ) {
							$sJoin .= " INNER JOIN `sys_tags` ON (`sys_tags`.`Type` = 'profile' AND `sys_tags`.`ObjID` = `P1`.`ID`) ";
                            $aWhere[] = "`sys_tags`.`Tag` = '" . process_db_input($mValue, BX_TAGS_STRIP) . "'";
                        } else
							$aWhere[] = "`P1`.`$sItemName` LIKE '%" . process_db_input($mValue, BX_TAGS_STRIP) . "%'";
                    break;

                    case 'num':
                        $mValue[0] = (int)$mValue[0];
                        $mValue[1] = (int)$mValue[1];
						$aWhere[] = "`P1`.`$sItemName` >= {$mValue[0]} AND `P1`.`$sItemName` <= {$mValue[1]}";
                    break;
                    ...
                    case 'date':
						...
						$aWhere[] = "DATEDIFF( NOW(), `P1s`.`$sItemName` ) >= $iMin AND DATEDIFF( NOW(), `P1`.`$sItemName` ) <= $iMax"; // TODO: optimize it, move static sql part to the right part and leave db field only in the left part
                    ...
                    case 'select_one':
                        if (is_array($mValue)) {
    						...
    						$aWhere[] = "(FIND_IN_SET( `P1`.`$sItemName`, '" . process_db_input($sValue, BX_TAGS_STRIP) . "' ) OR FIND_IN_SET( `P2`.`$sItemName`, '" . process_db_input($sValue, BX_TAGS_STRIP) . "' ))";
                        }
                    break;
                    ...
                    case 'select_set':
                        ...
                        foreach( $aMyValues as $sValue ) {
							...
							$aSet[] = "(FIND_IN_SET( '$sValue', `P1`.`$sItemName` ) OR FIND_IN_SET( '$sValue', `P2`.`$sItemName` ))";
                        }
		...
		$aWhere[] = "`P1`.`Status` = 'Active'";

        // add online only
        if( $_REQUEST['online_only'] ) {
            $iOnlineTime = getParam( 'member_online_time' );
			$aWhere[] = "`P1`.`DateLastNav` >= DATE_SUB(NOW(), INTERVAL $iOnlineTime MINUTE)";
        }
        ...
        switch($_REQUEST['show']) {
            case 'featured':
				$aWhere[] = "`P1`.`Featured` = '1'";
                break;
            case 'birthdays':
                $aWhere[] = "MONTH(`DateOfBirth`) = MONTH(CURDATE()) AND DAY(`DateOfBirth`) = DAY(CURDATE())";
                break;
            case 'top_rated':
				$sPossibleOrder = ' ORDER BY `P1`.`Rate` DESC';
                break;
            case 'popular':
				$sPossibleOrder = ' ORDER BY `P1`.`Views` DESC';
                break;
            case 'moderators':
				$sJoin .= " INNER JOIN `" . DB_PREFIX . "ChatProfiles` ON `P1`.`ID`= `" . DB_PREFIX . "ChatProfiles`.`ID` ";
        ...
        switch ($aFilterSortSettings['sort']) {
            case 'activity':
				$sPossibleOrder = ' ORDER BY `P1`.`DateLastNav` DESC';
                break;
            case 'date_reg':
				$sPossibleOrder = ' ORDER BY `P1`.`DateReg` DESC';
                break;
            default:
                break;
        }
        ...
        if( $_REQUEST['photos_only'] )
 		...
 		$aWhere[] = "(`P1`.`ProfileType` != '8') AND (`P1`.`Status` != 'Hidden')";

        $aWhere[] = "(`P1`.`Couple`='0' OR `P1`.`Couple`>`P1`.`ID`)";
    ...
    function GenSearchResultBlock($aSearchBlocks, $aRequestParams, $aFilterSortSettings = array(), $sPgnRoot = 'profile.php')
    {
		...
		$sIsOnlineSQL = ", if(`P1`.`DateLastNav` > SUBDATE(NOW(), INTERVAL {$iOnlineTime} MINUTE ), 1, 0) AS `is_online`";

		$sQuery = 'SELECT DISTINCT SQL_CALC_FOUND_ROWS IF( `P1`.`Couple`=0, `P1`.`ID`, IF( `P1`.`Couple`>`P1`.`ID`, `P1`.`ID`, `P1`.`Couple` ) ) AS `ID` ' . $sIsOnlineSQL . ' FROM `Profiles` P1 LEFT JOIN Profiles P2 ON P1.ID = P2.COUPLE ';
		
                
                $sQueryCnt = 'SELECT COUNT(DISTINCT IF( `P1`.`Couple`=0, `P1`.`ID`, IF( `P1`.`Couple`>`P1`.`ID`, `P1`.`ID`, `P1`.`Couple` ) )) AS "Cnt" FROM `Profiles` P1 LEFT JOIN Profiles P2 ON P1.ID = P2.COUPLE ';
  			...
  			//$sQuery .= 'ORDER BY `Profiles`.`Avatar` DESC';
                      ...
                      //$sQuery .= ' , `Profiles`.`Avatar` DESC';
                       ...
                       if($_GET['sort'] != '') {
                            ...
                            $sQuery .= ' , `P1`.`Avatar` DESC';

                        }
                        else {

                          $sQuery .= 'ORDER BY `P1`.`Avatar` DESC';
