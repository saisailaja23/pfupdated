...
<script type="text/javascript">
	tinyMCE_GZ.init({
		themes : "advanced",
		plugins : "imagemanager,filemanager,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,zoom,media,searchreplace,print,contextmenu,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras",
		languages : "en",
		disk_cache : true,
		debug : false
	});
	...
	function InitTiny() {
		tinyMCE.init({
			...
			mode : "specific_textareas",
			theme : "advanced",
			plugins : "imagemanager,filemanager,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,media,searchreplace,print,contextmenu,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras",
			//[START DeeEmm TinyBrowser MOD]
			file_browser_callback : "tinyBrowser",
			//[END DeeEmm TinyBrowser MOD]
			...
			theme_advanced_buttons3 : "insertfile,insertimage,charmap,emotions,|,cite,abbr,acronym,attribs,|,preview,removeformat",
			theme_advanced_toolbar_location : "top",
...
<script type="text/javascript">
	tinyMCE_GZ.init({
		plugins : "imagemanager,filemanager,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,zoom,media,searchreplace,print,contextmenu,directionality,fullscreen,visualchars,nonbreaking,xhtmlxtras",
		themes : "advanced",
		languages : "en",
		disk_cache : true,
		debug : false
	...
	function InitTiny() {
		...
		tinyMCE.init({
			...
			plugins : "imagemanager,filemanager,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,media,searchreplace,print,contextmenu,directionality,fullscreen,visualchars,xhtmlxtras",
			...
			theme_advanced_buttons3 : "insertfile,insertimage",
			theme_advanced_toolbar_location : "top",
			theme_advanced_toolbar_align : "left",
			theme_advanced_statusbar_location : "bottom",
...
<!-- /tinyMCE -->';
$this -> sTinyMceEditorMiniJS  = $this -> sTinyMceEditorJS;
...
<script type="text/javascript">
	tinyMCE_GZ.init({
		themes : "advanced",
		plugins: "imagemanager,filemanager,emotions",
		languages : "en",
		disk_cache : true,
		debug : false
