...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: MODE EXECUTION</title>
...
<img src="media/logo.png">
 ...
 <br>
<center>
<form name="fmrx" method="post" action="modeexec.php?IDX=<?php 

echo $_GET["IDX"];

?>">
<table width='30%' cellpadding='2' border='0'>
<tr><td colspan="2" align="center"><font style="color: black;"><b>CYBER MODE EXECUTION</b></font></td></tr>
<tr><td align="center" valign="center" colspan="2">&nbsp;</td></tr>
<tr><td align="center" valign="center"><input type="radio" name="modexec" value="1"><font style="color: black;"><b>&nbsp;Silent Mode</b></font></td>
<td align="right"><font style="color: black;"><b>Deixa Malware em modo silencioso.</b></font></td></tr>

<tr><td align="center" valign="center"><input type="radio" name="modexec" value="2"><font style="color: black;"><b>&nbsp;Active Mode</b></font></td>
<td align="right"><font style="color: black;"><b>Deixa Malware em modo ativo.</b></font></td></tr>

<tr><td align="center" valign="center"><input type="radio" name="modexec" value="3"><font style="color: black;"><b>&nbsp;Speed Mode</b></font></td>
<td align="right"><font style="color: black;"><b>Deixa Malware em modo r&aacute;pido.</b></font></td></tr>

<tr><td align="center" valign="center" colspan="2">&nbsp;</td></tr>

<tr><td align="right" colspan="2">
<input type="submit" value="OK" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.reload();">
</td></tr>
</table><br>
