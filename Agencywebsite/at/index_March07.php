...
if(!isset($_GET['max_race_id'])){
    ...
    $data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?pstart='.$_GET[pstart].'&pend='.$_GET['pend']);
   }

else {

  $data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$_GET['pstart'].'&pend='.$_GET['pend']);

   }
}
elseif(isset($_GET['search']) && !isset($_GET['max_race_id'])){
$data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?search='.$_GET[search]);

}
elseif(isset($_GET['max_race_id'])){

$data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);

}
else {

    $data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php');
...
<div style="margin-left:30px;"><a href="advsearch.php" ><img class="mainLogo" alt="logo" src="images/advanced_btn.png"></a></div>
            ...
            <div class="art-content">
                ...
                </div><div>&nbsp;</div><a href="http://ctstagepf.parentfinder.com/">
...
<!-- -->
<?php
echo '<div style="margin-top:540px;text-align:center;">';
...
if(isset($_GET['search'])){
	$data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?getpa=true&search='.$_GET[search]);
}else{
	$data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?getpa=true');
	$aData = (explode("#####",$data));
	//print_r($aData);
	$i=0;
	$p = 0;
...
$data = file_get_contents('http://ctstagepf.parentfinder.com/badgewaitingfamiliesatmain.php?getpa=true&max_race_id=7&famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);
