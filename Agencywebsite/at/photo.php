...
<?php
 ...
 //$data = file_get_contents('http://ctstagepf.parentfinder.com/test.php?profile='.$_GET['profile'].'&deta=details');
 //$aData = (explode(";-",$data));
 $data = file_get_contents($site['url'].'test.php?profile='.$_GET['profile']);
 $aData = (explode(";-",$data));
$data = file_get_contents($site['url'].'getphotosvideos.php?profile='.$_GET['profile'].'&p=watch');
//$data = file_get_contents('http://ctstagepf.parentfinder.com/getphotosvideos.php?profile=644&p=watch');
$photos = (explode(";-",$data));
array_pop($photos);
...
<head id="Head"><meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    ...
    <title>Photo - <?=$aData1[3]?><?php if($aData1[4] != '') { ?> & <?php } ?><?=$aData1[4]?></title>
...
<link rel="stylesheet" type="text/css" media="screen,print" href="css/newCssByJk1.css">
        ...
        <div class="art-Sheet-body">
            <div class="art-Header">
                ...
                <div class="header-buttons">
                    <a href="#"><div class="button">Contact Us</div></a>
                    <a href="#"><div class="button">Info Packets</div></a>
                    <a href="#"><div class="button">Newsletter</div></a>

                    <a href="#"><div id="why-donate" class="button">DONATE NOW</div></a>
                </div>
...
if(isset($_GET['pstart']) && $_GET['pstart'] != 0){
	...
	$spage = $_GET['page'] - 1;
	echo '<a href="photo.php?pstart='.$lpstart.'&pend='.$lpend.'&page='.$spage.'&profile='.$_GET['profile'].'" class="more">Prev</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
}
if(isset($_GET['search'])){
		...
		if($aData[$p] != ''){
			...
			if($_GET['page'] == $i){
				...
				echo '<div style=margin-left:30px;margin-top:10px;><b>'.$i.'</b></div> &nbsp;';
					...
					echo '<a href="photo.php?pstart='.$pstart.'&pend=12&page='.$i.'&profile='.$_GET['profile'].'">'.$i.'</a> &nbsp;';
			}
			$pstart = $pend + 0;
			$pend = $pend + 12;
		}
	...
	if($currentpage != $i){
		...
		echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="photo.php?pstart='.$lpstart.'&pend='.$lpend.'&page='.$page.'&profile='.$_GET['profile'].'" class="next">Next</a>';
...
if(isset($_GET['pstart']) && $_GET['pstart'] != 0){
  ...
  echo '<a href="photo.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$lpstart.'&pend='.$lpend.'&page='.$spage.'&button=Submit+Search" class="more">Prev</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
			...
			if($_GET['page'] == $i){
				...
				echo '<b>'.$i.'</b> &nbsp;';
					...
					//echo '<a href="index.php?max_race_id=7&beth[]='.$bethz.'&pareth='.$parethz.'&famreg='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&page=family_profile%2Fbrowse&button=Submit+Search">'.$i.'</a> &nbsp;'; pstart='.$pstart.'&pend=12&page='.$i.'"
                                   echo '<a href="photo.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$pstart.'&pend=12&page='.$i.'&button=Submit+Search">'.$i.'</a> &nbsp;';
	...
	if($currentpage != $i){
		if(isset($_GET['pend'])){
			...
			$page = 2;
               ...
               if($i !=''){
                echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="photo.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$lpstart.'&pend='.$lpend.'&page='.$page.'&button=Submit+Search" class="next">Next</a>';
                   }
