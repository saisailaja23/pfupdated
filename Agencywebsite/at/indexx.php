...
if(!isset($_GET['max_race_id'])){
    ...
    $data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?pstart='.$_GET[pstart].'&pend='.$_GET['pend']);
   }

else {

  $data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$_GET['pstart'].'&pend='.$_GET['pend']);

   }
}
elseif(isset($_GET['search']) && !isset($_GET['max_race_id'])){
$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?search='.$_GET[search]);

}
elseif(isset($_GET['max_race_id'])){

$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);

}
else {

    $data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php');
...
<div style="margin-left:30px;"><a href="advsearch.php" ><img class="mainLogo" alt="logo" src="images/advanced_btn.png"></a></div>
            ...
            <div class="art-content">
                ...
                </div><div>&nbsp;</div><div>&nbsp;</div><a href="http://ctstagepf.parentfinder.com/r.com/">
...
<div style =" position:relative;float:left;width:165px;height:auto;">
<?php }

$profile = $familyData[0];
//$datas = file_get_contents('http://ctstagepf.parentfinder.com/r.com/achose1.php?profile='.$profile);
//$aDatas = (explode(";-",$datas));
//$datap = file_get_contents('http://ctstagepf.parentfinder.com/r.com/test1.php?profile='.$profile);
...
?>  
			<?php if($familyData[3]!='') { ?>
     		...
     		<div class="one1">
                    ...
                    <div class="one"><a href="mainProfile.php?profile=<?=$profile?>" class="photob"><img src="<?=$familyData[3]?>" width="100" height="75" border="0"/></a></div>
		...
		<?php }
			...
			<div class="one1">
                        ...
                        <div class="one"><img src="images/noimage.jpg" width="100" height="75" border="0"/></div>
                        <div style="text-align: center;margin-top:10px;"><a href="mainProfile.php?profile=<?=$profile?>" class="black"><?=$familyData[1]?> <? if($familyData[2] != ''){ ?> &amp; <?=$familyData[2]?> <? } ?></a></div>
     		...
     		<div class="one1">
                ...
                <div style="text-align: center;margin-top:10px;"><a href="mainProfile.php?profile=<?=$profile?>" class="black"><?=$familyData[1]?> <? if($familyData[2] != ''){ ?> &amp; <?=$familyData[2]?> <? }?></a></div>
                	...
                	<?php }
                     ...
                     <div class="one1">
			<div class="one">
                            <img src="images/noimage.jpg" width="100" height="75" border="0"/></div>
                            <div style="text-align: center;margin-top:10px;"><a href="mainProfile.php?profile=<?=$profile?>" class="black"><?=$familyData[1]?> <? if($familyData[2] != ''){ ?> &amp; <?=$familyData[2]?> <? }?></a></div>
...
if(isset($_GET['search'])){
	$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?getpa=true&search='.$_GET[search]);
}else{
	$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?getpa=true');
	$aData = (explode("#####",$data));
	//print_r($aData);
	$i=0;
	$p = 0;
...
if(isset($_GET['search'])){
	//$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamilies.php?getpa=true&search='.$_GET[search]);
}else {
	//$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamilies.php?getpa=true');

$data = file_get_contents('http://ctstagepf.parentfinder.com/r.com/badgewaitingfamiliesat.php?getpa=true&max_race_id=7&famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);
