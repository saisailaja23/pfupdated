...
if(!isset($_GET['max_race_id'])){
    ...
    $data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?pstart='.$_GET[pstart].'&pend='.$_GET['pend']);
   }

else {

  $data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$_GET['pstart'].'&pend='.$_GET['pend']);

   }
}
elseif(isset($_GET['search']) && !isset($_GET['max_race_id'])){
$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?search='.$_GET[search]);

}
elseif(isset($_GET['max_race_id'])){

$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);

}
elseif(isset($_GET['childeth'])){

  
    $data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?childeth='.$_GET[childeth]);
    ...
    $data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php');
...
<ul id="nav">
  ...
  <li id="nav-03"><a href="http://www.adoption-alliance.com/waiting-families-texas-tx" title=""><span>Waiting Families adoption and texas</span></a></li>
...
<div style ="position:relative;float:left;width:125px;height:auto;">
<?php //}
...
?>
			<?php if($familyData[3]!='') { ?>
     		...
     		<div class="oneside1">
                    ...
                    <div class="oneside"><a href="mainProfile.php?profile=<?=$profile?>" class="photob"><img src="<?=$familyData[3]?>" width="92" height="70" border="0"/></a></div>
		...
		<?php }
			...
			<div class="oneside1">
                        ...
                        <div class="oneside"><img src="images/noimage.jpg" width="92" height="70" border="0"/></div>
                        <div style="text-align: center;margin-top:10px;"><a href="mainProfile.php?profile=<?=$profile?>" class="black"><?=$familyData[1]?> <? if($familyData[2] != ''){ ?> &amp; <?=$familyData[2]?> <? } ?></a></div>
...
<!-- -->
<?php
echo '<div style="margin-top:420px;text-align:center;">';
if(isset($_GET['pstart']) && $_GET['pstart'] != 0){
	$lpend = 24;//$_GET['pend'] - 5;
	//$lpstart = $lpend - 24;
        $lpstart = $_GET['pstart'] - 24;
	$spage = $_GET['page'] - 1;
	echo '<a href="waitingfamilies.php?pstart='.$lpstart.'&pend='.$lpend.'&page='.$spage.'" class="more">Prev</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
}
if(isset($_GET['search'])){
	$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?getpa=true&search='.$_GET[search]);
}else{
	$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?getpa=true');
	$aData = (explode("#####",$data));
	//print_r($aData);
	$i=0;
	$p = 0;
		...
		if($aData[$p] != ''){
			...
			if($_GET['page'] == $i){
				...
				echo '<b>'.$i.'</b> &nbsp;';
					...
					//echo '<a href="waitingfamilies.php?pstart='.$pstart.'&pend='.$pend.'&page='.$i.'">'.$i.'</a> &nbsp;';
					echo '<a href="waitingfamilies.php?pstart='.$pstart.'&pend=24&page='.$i.'">'.$i.'</a> &nbsp;';
			}
			$pstart = $pend + 0;
			$pend = $pend + 24;
		}
	...
	if($currentpage != $i){
		...
		echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="waitingfamilies.php?pstart='.$lpstart.'&pend='.$lpend.'&page='.$page.'" class="next1">Next</a>';
...
if(isset($_GET['pstart']) && $_GET['pstart'] != 0){
	...
	$spage = $_GET['page'] - 1;
        ...
        //echo '<a href="waitingfamilies.php?max_race_id=7&famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$lpstart.'&pend='.$lpend.'&page='.$spage.'" class="more">Prev</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';


  echo '<a href="waitingfamilies.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$lpstart.'&pend='.$lpend.'&page='.$spage.'&button=Submit+Search" class="more">Prev</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
...
if(isset($_GET['search'])){
	//$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamilies.php?getpa=true&search='.$_GET[search]);
}else {
	//$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliess.php?getpa=true');

$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamiliesalliance.php?getpa=true&max_race_id=7&famreg='.$famregz.'&pareth='.$parethz.'&beth='.$bethz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state]);
	...
	//for($cnt = 0; $cnt <= 42; $cnt =$cnt+24)
	{
		if($aData[$p] != ''){
			...
			echo '<b>'.$i.'</b> &nbsp;';
					...
					//echo '<a href="waitingfamilies.php?pstart='.$pstart.'&pend='.$pend.'&page='.$i.'">'.$i.'</a> &nbsp;';echo '<a href="waitingfamilies.php?pstart='.$pstart.'&pend=12&page='.$i.'">'.$i.'</a> &nbsp;';echo '<a href="waitingfamilies.php?pstart='.$pstart.'&pend=12&page='.$i.'">'.$i.'</a> &nbsp;';
					//echo '<a href="waitingfamilies.php?max_race_id=7&beth[]='.$bethz.'&pareth='.$parethz.'&famreg='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&page=family_profile%2Fbrowse&button=Submit+Search">'.$i.'</a> &nbsp;'; pstart='.$pstart.'&pend=12&page='.$i.'"
                                   echo '<a href="waitingfamilies.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$pstart.'&pend=24&page='.$i.'&button=Submit+Search">'.$i.'</a> &nbsp;';
	...
	if($currentpage != $i){
		if(isset($_GET['pend'])){
			...
			$page = 2;
               ...
               if($i !=''){
                echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="waitingfamilies.php?max_race_id=7&beth[]='.$bethz.'&pareth[]='.$parethz.'&famreg[]='.$famregz.'&family_num_children='.$_GET[family_num_children].'&family_state='.$_GET[family_state].'&pstart='.$lpstart.'&pend='.$lpend.'&page='.$page.'&button=Submit+Search" class="next1">Next</a>';
                   }
