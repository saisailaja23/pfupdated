...
?>
			<?php if($familyData[3]!='') { ?>
     		...
     		<div class="families">
                    ...
                    <div><a href="mainProfile.php?profile=<?=$profile?>" class="photob"><img src="<?=$familyData[3]?>" width="100" height="75" border="0"/></a></div>
		...
		<?php }
			...
			<div class="families">
                        ...
                        <div><img src="images/noimage.jpg" width="100" height="75" border="0"/></div>
                        <div style="text-align: center;margin-top:10px;"><a href="mainProfile.php?profile=<?=$profile?>" class="black"><?=$familyData[1]?> <? if($familyData[2] != ''){ ?> &amp; <?=$familyData[2]?> <? } ?></a></div>
...
if(isset($_GET['search'])){
	...
	//$data = file_get_contents('http://www.parentfinder.com/badgewaitingfamilies.php?getpa=true');
