<?php
session_start();
 //$data = file_get_contents('http://www.parentfinder.com/test.php?profile='.$_GET['profile'].'&deta=details');
 //$aData = (explode(";-",$data));
 $data = file_get_contents('http://www.parentfinder.com/test.php?profile='.$_GET['profile']);
 $aData = (explode(";-",$data));
$data = file_get_contents('http://www.parentfinder.com/getphotosvideos.php?profile='.$_GET['profile'].'&p=watch');
//$data = file_get_contents('http://www.parentfinder.com/getphotosvideos.php?profile=644&p=watch');
$photos = (explode(";-",$data));
array_pop($photos);
...
<title>Photographs - <?=$aData[3]?><?php if($aData[4] != '') { ?> & <?php } ?><?=$aData[4]?></title>
...
<div id="column-left">
    ...
    <h2 id="search-index">Photo Gallery</h2>
  <div class="content">
