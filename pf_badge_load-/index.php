...
<!--<script type="text/javascript"  src="http://www.parentfinder.com/pf_badge_load/js/handlebars.js"></script>-->
...
var sn=jqueryNoConflict('#searchInput').val();
 ...
 if(sk || st || sn) {
 var url='<?php echo $gsiteName; ?>pf_badge_load/json-data.php?page=index&sstat=scroll&uid='+uid+'&start='+s+'&end='+e+'&sortvalue='+sk+'&type='+st+'&name='+sn;
 }else{
 var url='<?php echo $gsiteName; ?>pf_badge_load/json-data.php?page=index&uid='+uid+'&start='+s+'&end='+e;
 }
...
function retriveData(id,uid,s,e) {
        jqueryNoConflict.getJSON('<?php echo $gsiteName; ?>pf_badge_load/json-data.php?page=index&uid='+uid+'&start='+s+'&end='+e, function(data) { 
                ...
                <div class="pf_modal-body">
                    ...
                    <div class="pf_popupcl01">
                        ...
                        <div class="likeButtons">
                            <div class="likepop pf_popup_login_cl08" data-dismiss="modal"></div>
                        </div>
                    </div>
                </div>
            </div>
