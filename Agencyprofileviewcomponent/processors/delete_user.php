...
mysql_query("INSERT INTO `profile_status` (`UserId`, `Status`, `IPaddr`) VALUES ('" . $Profile_id . "', '" . $Profile_status . "', '" . $ipaddr . "')");
...
echo json_encode(array(
'status' => 'err',
'response' => 'Could not read the data: ' . mysql_get_last_message()
));
}
