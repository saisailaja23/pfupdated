...
//$columns = '';
	$Agencydetails = db_res("SELECT  ID,FirstName,DateOfBirth,State,waiting,noofchildren,faith,ChildEthnicity,ChildAge,Adoptiontype,Avatar,NickName,Occupation,Religion,Education,Ethnicity,Couple,Country from Profiles where ID = " . $agency_id . "");
    $gridData = array();
	...
	$gridData[$row_agency['ID']]['DateOfBirth'] = $first_age ? $first_age : "NA";
        $gridData[$row_agency['ID']]['Education'] = $row_agency['Education'] ? $row_agency['Education'] : "NA";
        $gridData[$row_agency['ID']]['Occupation'] = $row_agency['Occupation'] ? $row_agency['Occupation'] : "NA";
        $gridData[$row_agency['ID']]['Ethnicity'] = $row_agency['Ethnicity'] ? $row_agency['Ethnicity'] : "NA";
        $gridData[$row_agency['ID']]['Religion'] = $row_agency['Religion'] ? $row_agency['Religion'] : "NA";
        $gridData[$row_agency['ID']]['FirstName'] = $row_agency['FirstName'] ? $row_agency['FirstName'] : "NA";
        ...
        if($row_agency['Couple'] != 0 && $row_agency['Couple'] != '') {
            ...
            while (($row_agency_couple = mysql_fetch_array($Agencydetails_Couple, MYSQL_BOTH))) {
                ...
                $gridData[$row_agency_couple['ID']]['DateOfBirth'] = $second_age ? $second_age : "NA";
                $gridData[$row_agency_couple['ID']]['Education'] = $row_agency_couple['Education'] ? $row_agency_couple['Education'] : "NA";
                $gridData[$row_agency_couple['ID']]['Occupation'] = $row_agency_couple['Occupation'] ? $row_agency_couple['Occupation'] : "NA";
                $gridData[$row_agency_couple['ID']]['Ethnicity'] = $row_agency_couple['Ethnicity'] ? $row_agency_couple['Ethnicity'] : "NA";
                $gridData[$row_agency_couple['ID']]['Religion'] = $row_agency_couple['Religion'] ? $row_agency_couple['Religion'] : "NA";
                $gridData[$row_agency_couple['ID']]['FirstName'] = $row_agency_couple['FirstName'] ? $row_agency_couple['FirstName'] : "NA";
            }
        }
...
//  $waiting =  $row_agency[4].' years';
        ...
        $country = (trim($row_agency[17])) ? $row_agency[17] : "NA";
...
//        $childethnicity = htmlentities($childethnicity);
        $childethnicity = ($childethnicity) ? $childethnicity : "NA";
...
//        $Childages = htmlentities($Childages);
        $Childages = ($Childages) ? $Childages : "NA";
...
// $flipbook = substr($E_book_link, $start, $end);
// $flipbook = substr($flipbook, strlen("https://www.parentfinder.com/"));
