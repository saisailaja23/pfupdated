...
(function( $, window, document, undefined ) {
	var Slider = {
		...
		init: function( options, elem ) {
			...
			$('.coda-slider').prepend('<p class="loading">Loading...<br /><img src="KevinBatdorf-codaslider-b404ecf/img/ajax-loader.gif" width="220" height="19" alt="loading..." /></p>');
		...
		addArrows: function(){
			...
			//}
			//else{
				//$(self.sliderId).before('<div class="coda-nav-left" data-dir="prev" title="Slide left"><a href="#"><img src="http://test5.parentfinder.com/templates/tmpl_Latest/images/arrow_left.png" /></a></div>');
				//$(self.sliderId).after('<div class="coda-nav-right" data-dir="next" title="Slide right"><a href="#"><img src="http://test5.parentfinder.com/templates/tmpl_Latest/images/arrow_right.png" /></a></div>');
                             $(self.sliderId).before('<div class="coda-nav-left" data-dir="prev" title="Slide left"><a href="#"><img src="KevinBatdorf-codaslider-b404ecf/img/arrow_left.png"  /></a></div>');
				  $(self.sliderId).after('<div class="coda-nav-right" data-dir="next" title="Slide right"><a href="#"><img src="KevinBatdorf-codaslider-b404ecf/img/arrow_right.png" /></a></div>');
