$(document).ready(function() {
  ...
  if (hostname === "kak-iin.firmsitepreview.com") {
    $('body').attr('style', 'background-color: #efefef !important');
    //$('.pf_view_cl04 span:first-child').attr('style', 'background-color: #8e4387 !important');
  }
  
  if(hostname === "heartofadoptions.com" || hostname === "heartofadoptionsalliance.com"){
      $( "div.searchFamilies > div.search" ).css( 'background','#d5594f' );
  }
  else if(hostname == "christianservices.org") {
      $( "div.searchFamilies > div.search" ).css( 'background','#ebf0da' );
      $( "div.searchFamilies > div.search" ).css( 'color','#7c4d1f' );
  }
...
//  }, 5000);
  ...
  agencyId = getUrlVars().agencyId ;
  
  if(adoption_agency != 0)
    agencyId = adoption_agency;
  ...
  $.getJSON(siteurl + 'viewourfamilies/processors/familylike_listJson.php?loadFrom=' + loadFrom + '&agencyId=' + agencyId + '&sortvalue=' + sortvalue + '&type=' + type, function(jd) {
...
//    }
    ...
    if (hostname === "www.indianaadoption.com" || hostname === "kak-iin.firmsitepreview.com")
    ...
    if (hostname === "www.indianaadoption.com" || agencyId == 188)
      div.find('.age').parent().css('display', 'none');
    if (agencyId == 188) {
      div.find('.waiting').parent().css('display', 'none');
      div.find('.ourchild').html('OPEN TO ADOPTING');
    } 
...
//            debugger;
      ...
      else if(agencyId == 220) { //Colorado Christian Services styles 		
		
        $( "div.pf_content_menu > a" ).css( 'background','#7ddfde' );
        $( "div.pf_content_menu > a:hover" ).css( 'background','#56b4b3' );
        $( "div.pf_content_menu > a.last" ).css( 'background','#ebf0da' );
        $( "div.pf_content_menu > a.last" ).css( 'color','#7c4d1f' );
        
        $( "div.pf_profile_filter_cl01" ).css( 'background','#7ddfde' );
        $( "div.pf_profile_filter_cl01 > div.btn-group" ).css( 'background','#7ddfde' );
        $( ".selectpicker").css( 'background','#7ddfde' );
        $( ".pf_view_cl013" ).css( 'background','#ebf0da' );
        $( ".pinkBar" ).css('background-color', '#ebf0da !important');
        $( ".pinkBar" ).css( 'background','#ebf0da');
        $($('.pinkBar')).attr('class', 'pinkBarCCS');
        $(".pf_more_cl011").css( 'background','#7ddfde' );
        $(".pf_content_menu").find("ul").find("li").hover(function(){ $(this).css('background-color', '#7ddfde'); });
        $(".pf_content_menu").find("ul").find("li").mouseout(function(){ $(this).css('background-color', 'white'); });  
        $(".nodialog").css( 'color','#7c4d1f !important' );
        $(".toolhelp").hover(function(){$(this).css('border-color','#d5594f');});
        // Changing icons
        // $( ".pf_profile_cl02" ).css('background-image','url("/viewourfamilies/images/HOA/icon_profile_print.png")');
        $('#reload').css('background-image','url("/viewourfamilies/images/CCS/icon_reset.png")');
        $('.pf_view_cl04 img').css('background-color', '#63431C');
        $( ".pf_profile_cl02" ).attr('src','/viewourfamilies/images/CCS/icon_print.png');
        div.find('.pf_view_cl07').find( ".pf_view_cl08" ).css('background-image','url("/viewourfamilies/images/CCS/icon_aboutus.png")');
        div.find('.pf_view_cl07').find( ".pf_view_cl09" ).css('background-image','url("/viewourfamilies/images/CCS/icon_ourhome.png")');
        div.find('.pf_view_cl07').find( ".pf_view_cl010" ).css('background-image','url("/viewourfamilies/images/CCS/icon_ourletters.png")');
        div.find('.pf_view_cl07').find( ".pf_view_cl011" ).css('background-image','url("/viewourfamilies/images/CCS/icon_contact.png")');
        div.find('.pf_view_cl07').find( ".pf_view_cl012" ).css('background-image','url("/viewourfamilies/images/CCS/icon_ourvideos.png")');
        div.find('.pf_view_cl07').find( ".pf_profile_cl013" ).css('background-image','url("/viewourfamilies/images/CCS/icon_ebook.png")');
        
        if (data[count].profile_id_Couple == 0) {
            div.find('.pf_view_cl07').find('a.pf_view_cl08').css('background-image','url("../viewourfamilies/images/singleparent/christianservices/icon_more_about_me.png")');
            div.find('.pf_view_cl07').find('a.pf_view_cl09').css('background-image','url("../viewourfamilies/images/singleparent/christianservices/icon_my_home.png")');
            div.find('.pf_view_cl07').find('a.pf_view_cl010').css('background-image','url("../viewourfamilies/images/singleparent/christianservices/icon_my_letters.png")');
            div.find('.pf_view_cl07').find('a.pf_view_cl012').css('background-image','url("../viewourfamilies/images/singleparent/christianservices/icon_ourvideos.png")');
        }
    }
    }
//    div.find('.pf_view_cl08').attr('href', siteurl + 'moreaboutus.php?id=' + data[count].profile_id + '&loadFrom=' + loadFrom);
    ...
    div.find('.pf_view_cl013').attr('href', "javascript:void(0)");
      ...
      div.find('.pf_view_cl013').attr('onclick', '');
    } */
//Print icon profile
  ...
  var scrollEventBadge = function() {
    ...
    $('#outerFixed').on('scroll', function(event) {
      ...
      var scroll = $('#outerFixed').scrollTop();
            //debugger;
//      console.log($('.pf_view_cl01').height()+'--'+$('#outerFixed').height());
...
//	if (loadedRecords == totalRecords) {
	...
	$.getJSON(siteurl + 'viewourfamilies/processors/familylike_listJson.php?sortvalue=' + $('#sortyby').val() + "&type=" + $('#type').val() + '&loadFrom=' + loadFrom + '&agencyId=' + agencyId + '&posStart=' + loadedRecords + '&pid=' + arrayprofileid + "&searchFilter=" + searchVal, function(jd) {
	  if (jd.count > 0) {
...
//	  $('.norecords').css('display', 'block');
  ...
  var ajaxLoadFamilies = function(sortVal, type, searchVal) {
    ...
    $('.loader').html('Loading');
    $.getJSON(siteurl + 'viewourfamilies/processors/familylike_listJson.php?sortvalue=' + sortVal + "&type=" + type + "&loadFrom=" + loadFrom + "&agencyId=" + agencyId + "&searchFilter=" + searchVal, function(jd) {
      if (jd.count > 0) {
	arrayprofileid = [];
	$('.new').empty()
	$('.new').remove();
