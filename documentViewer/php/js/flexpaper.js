...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    if (_uDoc != null) {
        ...
        _IMGFiles_thumbs    = translateUrlByFormat(_uDoc,"png");
    }
			...
			if(true){
				jQuery(document).ready(function() {
					...
					jQuery.getScript(conf.jsDirectory+'FlexPaperViewer.js', function() {
                        ...
                        if(conf.PdfFile!=null && conf.PdfFile.length>0 && conf.RenderingOrder.split(",").length>=1 && (supportsPDFJS || (oRenderingList[0] == 'html5' && oRenderingList.length==1)) && (oRenderingList[0] == 'html5' || (oRenderingList.length > 1 && oRenderingList[0] == 'flash' && oRenderingList[1] == 'html5')) && !(platform.touchdevice && oRenderingList.length > 1 && oRenderingList[1] == 'html')){
