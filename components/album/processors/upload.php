...
//        $fileNameA = explode('.', $file);
//        //print_r($fileNameA);
//        $fileName = $fileNameA[0].'_'.$time.'.'.$fileNameA[1];
        
//        echo $fileName;
        processvideo($root, $albumid, $fileName);
    }
}
...
function processimage($targetDir, $fileName) {
    ...
    echo $sql = "INSERT INTO bx_photos_main
...
//    $Options = " -ab 56 -ar 44100 -b 512k -r 15 -s " . $outputWidth . "x$outputHeight -f " . $vFormat . " "; // -vcodec flv
    $Options = " -vcodec copy -acodec copy -s " . $outputWidth . "x$outputHeight ";
//    $CommandLimg = $FfmpegPath . " -itsoffset 10 -i " . $OutputVideo . " -an -ss 00:00:03 -an -r 1 -vframes 1 -y " . $outputFile . ".jpg";
...
//    $CommandSimg = $FfmpegPath . " -itsoffset 10 -i " . $OutputVideo . " -an -ss 00:00:03 -an -r 1 -vframes 1 -s 220x170 -y " . $outputFile . "_small.jpg";
//    $log123 = fopen('log.log','a+');
//    fwrite($log123, $CommandLimg);
//    fwrite($log123, '-----');
//    fwrite($log123, $CommandSimg);
//    fclose($log123);
//    $CommandLimg=$FfmpegPath ." -itsoffset 10 -i ". $inputFile ." -an -ss 00:00:03 -an -r 1 -vframes 1 -s 640x360 -y ". $outputFile.".jpg";
//    $CommandSimg=$FfmpegPath ." -itsoffset 10 -i ". $inputFile ." -an -ss 00:00:03 -an -r 1 -vframes 1 -s 220x170 -y ". $outputFile."_small.jpg";
