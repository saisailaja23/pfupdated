...
function processvideo($root,$albumid,$file){
   ...
   // $today = strtotime('today UTC');
    ...
    if(in_array($getOS,$array_phones))
    {
        ...
        $CommandLimg=$FfmpegPath ." -itsoffset 10 -i ". $inputFile ."  -vfilters rotate=90 -an -ss 00:00:03 -an -r 1 -vframes 1 -s 640x360 -y ". $outputFile.".jpg";
        $CommandSimg=$FfmpegPath ." -itsoffset 10 -i ". $inputFile ." -vfilters rotate=90 -an -ss 00:00:03 -an -r 1 -vframes 1 -s 220x170 -y ". $outputFile."_small.jpg";
