...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail, view;
      this.node = jQuery("<li/>");
	  view = jQuery("<a/>");
	  view.attr("href", this.option.data("imgfull-src"))
      view.attr("rel", "prettyPhoto");
      view.attr("title", this.label());
	  this.node.append(view);
...
//	  thumbnail.append(jQuery("<a/>").attr("href", this.option.data("imgFull-src")));
