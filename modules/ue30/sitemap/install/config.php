...
$aConfig = array(
	 ...
	 * Main Section.
	 */	
	'title' => 'Sitemap Generator', // module title, this name will be displayed in the modules list
    'version' => '1.0.0', // module version, change this number everytime you publish your mod
	'vendor' => 'ue30', // vendor name, also it is a folder name in modules folder
	 ...
	 */
	'home_dir' => 'ue30/sitemap/', // folder where module files are located, it describes path from /modules/ folder.
	'home_uri' => 'ue30sg', // module URI, so the module will be accessable via the following urls: m/bloggie/ or modules/?r=bloggie/
	
	'db_prefix' => 'ue30_sg', // database prefix for all module tables, it is better to compose it from vendor prefix + module prefix, in out case it is me (vendor prefix) and blgg(Bloggie module prefix)
    'class_prefix' => 'Ue30Sg', // class prefix for all module classes, it is better to compose it from vendor prefix + module prefix, in out case it is Me (vendor prefix) and Blgg(Bloggie module prefix)
	 ...
	 */
	'language_category' => 'ue30 Sitemap Generator',
