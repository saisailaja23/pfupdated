...
(function($){
	$.fn.kRSSFeed = function(sForceUrl) {
		return this.each( function(){
			...
			var sFeedURL = (sForceUrl != undefined) ? sForceUrl : site_url + 'places.php/get_rss_feed/' + iRSSID;
...
(function($){
	$.fn.kRSSForm = function() {
		return this.each( function(){			
			...
			$.get( 'places.php/get_rss_form/' + iRSSID, function(sForm) {
				$Cont.html( sForm );
			} );
