...
$gConf['dir']['editor'] = BX_DIRECTORY_PATH_PLUGINS . 'tiny_mce4/'; // path to javascript editor
...
if (!$gConf['lang'] || !preg_match("/^[a-z]{2}$/", $gConf['lang']) || !file_exists($path . 'layout/base_' . $gConf['lang'])) {
...
$gConf['url']['editor'] = $site['plugins'] . 'tiny_mce4/'; // url to javascript editor
