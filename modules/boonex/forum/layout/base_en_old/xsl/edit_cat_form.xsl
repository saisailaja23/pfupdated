	...
	<div class="wnd_box">
        ...
        <div class="wnd_content">
            <form name="orca_edit_cat" onsubmit="var x=document.getElementById('js_code').innerHTML; eval(x); return false;">
                ...
                <fieldset class="form_field_row"><legend>Group name:</legend>
                    <input class="sh" type="text" name="cat_name" value="{cat_name}" />
                </fieldset>
                <br /><br />

                <fieldset class="form_field_row"><legend>Expand group by default:</legend>
                ...
                <fieldset class="form_field_row"><legend>Group order:</legend>
