...
<xsl:template name="canvas_init">
    ...
    <script type="text/javascript">
        ...
        tinyMCE_GZ.init({
        	plugins : 'table,imagemanager,filemanager,advimage,advlink,emotions,iespell,insertdatetime,preview,zoom,searchreplace,print,contextmenu,xhtmlxtras,media',
        	themes : 'advanced',
	...
	<script language="javascript" type="text/javascript">
        ...
        tinyMCE.init({
			...
			theme_advanced_buttons3_add : "emotions,insertfile,insertimage,iespell,flash,separator,print",
