...
class BxPmtModule extends BxDolModule
{
    ...
    {
        $aTopMenu = array(
            'pmt-memberhsip' => array('href' => BX_DOL_URL_ROOT . 'm/membership/index/', 'title' => _t('Back to membership')),
    ...
    function initializeCheckout($iVendorId, $sProvider, $aItems = array())
    {
        ...
        if(empty($iPendingId))
           ...
           // echo $iPendingId;
           // echo '<pre>'; print_r($aProvider); print_r($aInfo);exit();
       $biPassData= Array
            (
                'r' => 'payment/act_finalize_checkout/paypal/0',
                'mc_gross' => sprintf("%.2f", (float)$aInfo['items_price']),
                'protection_eligibility' => 'Ineligible',
                'payer_id' => 'EKVG8P4VTKH82',
                'tax' => '0.00',
                'payment_date' => '22:47:49 Jan 31, 2012 PST',
                'payment_status' => 'Completed',
                'charset' => 'windows-1252',
                'first_name' => 'Parent',
                'mc_fee' => '0.00',
                'notify_version' => '3.4',
                'custom' => 'fb9ce87f03a0429d0af0760d01b74612',
                'payer_status' => 'unverified',
                'business' => 'mark.livings@cairsolutions.com',
                'quantity' => 1,
                'verify_sign' => 'A4bPcsim4YZY-wx0L4VcYUvopZP4A0Y44XReMNav08EkRRVR6IPKy.uc',
                'payer_email' => 'mark.livings@cairsolutions.com',
                'txn_id' => '2KP068298B577674M',
                'payment_type' => 'instant',
                'last_name' => 'Finder',
                'receiver_email' => 'mark.livings@cairsolutions.com',
                'payment_fee' => '0.00',
                'receiver_id' => 'M2RZUBH6W58GE',
                'txn_type' => 'web_accept',
                'item_name' => 'Payment to: Administrator',
                'mc_currency' => 'USD',
                'item_number' => $iPendingId,
                'residence_country' => 'US',
                'receipt_id' => '4771-7784-0027-7521',
                'handling_amount' => '0.00',
                'transaction_subject' => 'fb9ce87f03a0429d0af0760d01b74612',
                'payment_gross' => sprintf("%.2f", (float)$aCartInfo['items_price']),
                'shipping' => '0.00',
                'ipn_track_id' => '90ab88501ce39',
                'bypass' =>'true'
            );
            if($aInfo['items_price']==0)
                    $this->actionFinalizeCheckout('paypal','',$biPassData);
            else
        return $oProvider->initializeCheckout($iPendingId, $aInfo);
    }
	function actionFinalizeCheckout($sProvider, $mixedVendorId = "",$biPassData='nodata') {
        if ($biPassData=='nodata')
        $aData = &$_REQUEST;
        else
             $aData = $biPassData;
