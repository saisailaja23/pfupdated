...
class BxGroupsPageView extends BxDolTwigPageView
{
    ...
    function getBlockCode_Dail() {
        return $this->_blockDail($this->aDataEntry);
    }	
...
// 'TitleSettings' => $this->_oMain->isAllowedAgencySettings($this->aDataEntry) ? _t('_bx_groups_action_settings') : '',
    ...
    function getBlockCode_Fans()
    {
       ...
       function getBlockCode_FansScroll()
    {
        return parent::_blockFansScroll ($this->_oDb->getParam('bx_groups_perpage_view_fans'), 'isAllowedViewFans', 'getFans');
        
        
    }
    
    //  function getBlockCode_LastActive()
   // {
     //   return parent::_blockLastActive ();
