	    ...
	    <div class="wnd_box">
			...
			<form name="orca_login_form" onsubmit="var s=document.getElementById('js_code').innerHTML; eval(s); return document.ret;">
				...
				<div class="forum_default_padding">
                        <input type="submit" name="submit_form" value="Послать" onclick="var x=document.getElementById('js_code').innerHTML; eval(x); return document.ret;" />
                        <input type="reset" value="Отменить" onclick="f.hideHTML(); return false;" class="forum_default_margin_left" />
				</div>				
