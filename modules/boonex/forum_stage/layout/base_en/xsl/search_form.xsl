...
<xsl:template match="search">
    ...
    <xsl:call-template name="box">
        <xsl:with-param name="title">Поиск по форуму</xsl:with-param>
                ...
                <div class="search_box">
                    ...
                    <div class="search_field bx-def-margin-bottom">
                        ...
                        <span class="search_input">
                            <input type="radio" name="search_type" id="search_type_tlts" value="tlts" style="position:static;" checked="checked"/> <label for="search_type_tlts">Названия тем</label>
                            &#160; &#160; &#160;
                            <input type="radio" name="search_type" id="search_type_msgs" value="msgs" style="position:static;" /> <label for="search_type_msgs">Сообщения</label>
                        </span>
                    </div>
                    ...
                    <div class="search_field bx-def-margin-bottom">
                        ...
                        <span class="search_input">
                            <select class="forum_form_field bx-def-font-large bx-def-round-corners-with-border" name="search_forum"> 
                                <option value="0">Весь Форум</option>
                    ...
                    <div class="search_field bx-def-margin-bottom">
                        <div>Отобразить:</div>
                        <span class="search_input">
                            <input type="radio" name="search_display" id="search_display_topics" value="topics" style="position:static;" checked="checked"/> <label for="search_display_topics">Сообщения</label>
                            &#160; &#160; &#160;
                            <input type="radio" name="search_display" id="search_display_posts" value="posts" style="position:static;" /> <label for="search_display_posts">Сообщения</label>
                        </span>
                    </div>

                    <div class="search_field">
                        <input type="submit" name="search_submit" value="Послать" onclick="var ff=document.forms['new_search'].elements; return f.search (ff.search_text.value, (ff.search_type[0].checked ? ff.search_type[0].value : ff.search_type[1].value), ff.search_forum.value, ff.search_author.value, (ff.search_display[0].checked ? ff.search_display[0].value : ff.search_display[1].value));" class="bx-btn" />
