    ...
    <xsl:template name="signature">
        <xsl:param name="text" />
                    ...
                    <div class="bx-def-margin-top">
                        <a href="javascript:void(0);" onclick="jQuery('#forum_signature').toggle(f._speed);">Изменить подпись</a>
                        <div id="forum_signature" style="display:none;">
                            <div class="forum_field_error_message" style="display:none" id="err_signature">Максимально 100 символов</div>
