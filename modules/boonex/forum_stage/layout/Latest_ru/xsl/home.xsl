<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:include href="../../base_ru/xsl/home.xsl" />
...
<xsl:template match="page">
	...
	<div id="f_header">
        <h2>
			...
			<xsl:if test="1 = /root/logininfo/admin">
                <span>(
                    <a href="javascript: orca_admin.editCategories(); void(0);">Форум Управление</a> | 
                    <a href="javascript: orca_admin.reportedPosts(); void(0);">Сообщения, отмеченные жалобами</a> | 
                    Компилировать языки:
	...
	<div id="f_tbl">
		<ul class="tbl_hh">
			<li class="tbl_h_forum">Форумы</li>
			<li class="tbl_h_topic">Сообщения</li>
			<li class="tbl_h_date">Последнее сообщение</li>
		</ul>
