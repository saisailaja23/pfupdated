...
OES;
    ...
    {
        return $this->getXxxPostsXML ($wp, 'getHiddenPosts', 'Спрятанные сообщения');
    }
    ...
    {
        return $this->getXxxPostsXML ($wp, 'getReportedPosts', 'Сообщения, отмеченные жалобами', '<allow_clear_report>1</allow_clear_report>');
    }
