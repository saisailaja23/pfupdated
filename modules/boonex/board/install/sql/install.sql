...
(0, 'Board', '_board_top_menu_item', 'modules/?r=board/home/|modules/?r=board/|modules/?r=photos/browse/category/Board|m/photos/browse/category/Board', @iTMOrder+1, 'non,memb', '', '', '', 1, 1, 1, 'top', 'modules/boonex/board/|bx_boards.png', 0, '');
...
INSERT INTO `sys_objects_actions`(`Caption`, `Icon`, `Script`, `Eval`, `Order`, `Type`) VALUES('{evalResult}', 'palette.png', 'window.open(''m/board/index/{ID}'',''_self'')', 'if ({Owner} == {iViewer} AND strtolower(''{Tags}'') == ''board'')\r\nreturn _t( ''_board_action_paint'' );\r\nelse\r\nreturn null;', 4, 'bx_photos');