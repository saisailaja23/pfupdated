...
$_page['css_name']		= '';
$_page['header'] = _t('_news_pcaption_categories');
...
$oCateg = new BxTemplCategoriesModule($aParam, _t('_news_bcaption_all_categories'), BX_DOL_URL_ROOT . $oNews->_oConfig->getBaseUri() . 'category');
