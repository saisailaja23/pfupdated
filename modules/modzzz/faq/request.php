...
class BxFAQRequest extends BxDolRequest {

    function BxFAQRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_FAQ_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxFAQRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);