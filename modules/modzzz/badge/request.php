...
class BxBadgeRequest extends BxDolRequest {

    function BxBadgeRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_Badge_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxBadgeRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
